...
- **Gamepad (2026-07-08):** left stick moves, right stick X = scan yaw (analog scales speed), **L2/R2 analog triggers = scan tilt** (press depth = tilt speed), B = reset; A jump, R1 ping, L1 focus. Keyboard + pad additive. Floating wireframe markers removed as clutter (columns are landmark enough).
