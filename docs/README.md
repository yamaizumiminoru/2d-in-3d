...
- **Gamepad (2026-07-08):** dual-analog — left stick moves, right stick scans (X = yaw, Y = tilt), analog magnitude scales speed; A jump, B reset-tilt, RB/RT ping, LB/LT focus. Keyboard + pad additive. Floating wireframe markers removed as clutter (columns are landmark enough).
