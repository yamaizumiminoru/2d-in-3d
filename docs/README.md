...
- **Gamepad (2026-07-08):** left stick moves, right stick X = scan yaw (analog scales speed), R1/L1 = scan tilt up/down (digital), L1+R1 = reset tilt; A jump, RT ping, LT focus, B secondary reset. Keyboard + pad additive. Floating wireframe markers removed as clutter (columns are landmark enough).
