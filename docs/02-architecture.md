...
3. Renders the 3D scene into the hidden 96 px strip, then blits the **center 3 px** (8 px in focus mode) of it into an **8 px** (18 px focus) column at screen center, rotated by `player.scanRoll`.
